(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["re-period-seletor"] = factory();
	else
		root["re-period-seletor"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PeriodSelector = __webpack_require__(1);

	var _PeriodSelector2 = _interopRequireDefault(_PeriodSelector);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	exports.default = _PeriodSelector2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var propTypes = {
	    nodeId: _react.PropTypes.string, // 自定义 id
	    baseClassName: _react.PropTypes.string, // 自定义 classname
	    labelText: _react.PropTypes.string, // 自定义 label
	    value: _react.PropTypes.string, // 当前            日期
	    periodOptions: _react.PropTypes.array, // 周期
	    options: _react.PropTypes.array, // 周期值
	    processValue: _react.PropTypes.func, // 值显示的处理函数
	...
	var defaultProps = {
	    ...
	    value: '每月1号',
	    periodOptions: ['每月', '每周'],
	    options: [Array.apply(undefined, _toConsumableArray(Array(28))).map(function (x, i) {
	        return ++i + '\u65E5';
	    }), ['星期一', '星期二', '星期三', '星期四', '星期五']],
	    processValue: function processValue(value, period, periodOptions) {
	        if (period === 0) {
	...
	var PeriodSelector = function (_Component) {
	    ...
	    function PeriodSelector(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, (PeriodSelector.__proto__ || Object.getPrototypeOf(PeriodSelector)).call(this, props));
	        ...
	        _this.mounted = true;
	        _this.displayValue = props.value;
	    ...
	    _createClass(PeriodSelector, [{
	        ...
	        value: function setValue(value) {
	            var _props = this.props,
	                processValue = _props.processValue,
	                periodOptions = _props.periodOptions;
	        ...
	        value: function buildMenu() {
	            ...
	            var _props2 = this.props,
	                ...
	                periodOptions = _props2.periodOptions,
	                options = _props2.options;
	            var period = this.state.period;

	            var title = periodOptions.map(function (item, index) {
	                var state = period === index ? 'active' : '';
	                return _react2.default.createElement(
	                    'div',
	                    {
	                        key: index,
	                        className: baseClassName + '-period ' + state,
	                        onMouseDown: _this2.setPeriod.bind(_this2, index),
	                        onClick: _this2.setPeriod.bind(_this2, index)
	                    },
	                    item
	                );
	            });
	            var ops = options[period].map(function (option, key) {
	                return _react2.default.createElement(
	                    'div',
	                    {
	                        key: key,
	                        className: _this2.props.baseClassName + '-option',
	                        onMouseDown: _this2.setValue.bind(_this2, option),
	                        onClick: _this2.setValue.bind(_this2, option)
	                    },
	                    option
	                );
	            });
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: baseClassName + '-options' },
	                    ops
	                )
	            );
	        }
	        ...
	        value: function render() {
	            var _props3 = this.props,
	                ...
	                labelText = _props3.labelText,
	                nodeId = _props3.nodeId;

	            var menu = this.state.isOpen ? this.buildMenu() : null;
	            var periodSelectorClass = baseClassName + '-root ' + (this.state.isOpen ? 'is-open' : '');
	            return _react2.default.createElement(
	                'div',
	                { className: periodSelectorClass },
	                _react2.default.createElement(
	                    'div',
	                    { className: baseClassName + '-bar', id: nodeId, onMouseDown: this.handleMouseDown, onTouchEnd: this.handleMouseDown },
	                    _react2.default.createElement(
	                        'span',
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/postcss-loader/index.js!../node_modules/less-loader/index.js!./PeriodSelector.less", function() {
				var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/postcss-loader/index.js!../node_modules/less-loader/index.js!./PeriodSelector.less");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".period-selector-root .period-selector-bar {\n  width: 100%;\n  height: 50px;\n  line-height: 50px;\n  position: relative;\n  background-color: #ffffff;\n  color: #555555;\n  font-size: 14px;\n  cursor: pointer;\n  font-weight: 700;\n}\n.period-selector-root .period-selector-bar span {\n  float: left;\n}\n.period-selector-root .period-selector-bar .period-selector-label {\n  padding-left: 2%;\n  width: 28%;\n  height: 100%;\n}\n.period-selector-root .period-selector-bar .period-selector-value {\n  float: left;\n  width: 40%;\n}\n.period-selector-root .period-selector-bar .period-selector-arrow {\n  float: right;\n  background-image: url(data:image/svg+xml;base64,);\n  background-repeat: no-repeat;\n  background-position: 50% 50%;\n  background-size: 10px;\n  width: 50px;\n  height: 50px;\n}\n.period-selector-root .period-selector-bar .period-selector-arrow:after {\n  content: \".\";\n  height: 0;\n  visibility: hidden;\n  display: block;\n  clear: both;\n}\n.period-selector-root .period-selector-menu {\n  position: absolute;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  height: 270px;\n  overflow: scroll;\n  z-index: 100;\n  background: white;\n}\n.period-selector-root .period-selector-menu .period-selector-title {\n  height: 40px;\n  border-bottom: 1px solid #bebebe;\n  display: -webkit-box;\n  display: -webkit-flex;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-align: center;\n  -webkit-align-items: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -webkit-box-pack: center;\n  -webkit-justify-content: center;\n      -ms-flex-pack: center;\n          justify-content: center;\n}\n.period-selector-root .period-selector-menu .period-selector-title .period-selector-period {\n  cursor: pointer;\n  height: 40px;\n  display: -webkit-box;\n  display: -webkit-flex;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-pack: center;\n  -webkit-justify-content: center;\n      -ms-flex-pack: center;\n          justify-content: center;\n  -webkit-box-align: center;\n  -webkit-align-items: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -webkit-box-flex: 1;\n  -webkit-flex-grow: 1;\n      -ms-flex-positive: 1;\n          flex-grow: 1;\n}\n.period-selector-root .period-selector-menu .period-selector-options {\n  height: 199px;\n  margin: 15px 0px 15px 0px;\n  display: -webkit-box;\n  display: -webkit-flex;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-justify-content: space-around;\n      -ms-flex-pack: distribute;\n          justify-content: space-around;\n  -webkit-box-align: center;\n  -webkit-align-items: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -webkit-align-content: space-around;\n      -ms-flex-line-pack: distribute;\n          align-content: space-around;\n  -webkit-box-orient: horizontal;\n  -webkit-box-direction: normal;\n  -webkit-flex-flow: row wrap;\n      -ms-flex-flow: row wrap;\n          flex-flow: row wrap;\n}\n.period-selector-root .period-selector-menu .period-selector-options .period-selector-option {\n  width: 50px;\n  height: 22px;\n  margin-left: 5px;\n  margin-right: 5px;\n  border: 1px solid #ebebeb;\n  border-radius: 5px;\n  font-size: 15px;\n  color: #303030;\n  display: -webkit-box;\n  display: -webkit-flex;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-pack: center;\n  -webkit-justify-content: center;\n      -ms-flex-pack: center;\n          justify-content: center;\n  -webkit-box-align: center;\n  -webkit-align-items: center;\n      -ms-flex-align: center;\n          align-items: center;\n  overflow: hidden;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n  cursor: pointer;\n}\n.period-selector-root .period-selector-menu .period-selector-options .period-selector-option:active {\n  background-color: #d9d9d9;\n}\n.period-selector-root .period-selector-menu .period-selector-options .period-selector-option:hover {\n  background-color: #d9d9d9;\n}\n", ""]);
